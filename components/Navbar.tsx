        ...
        <div className="px-6 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-4 group">
            ...
            <div className="flex flex-col">
              <span className="text-royal-yellow font-serif font-extrabold text-xl md:text-3xl leading-none tracking-tighter transition-colors group-hover:text-royal-yellow">
                ROYAL TOUCH
              </span>
              <span className="text-white text-[6px] md:text-[9px] tracking-[0.5em] uppercase opacity-90 font-medium group-hover:opacity-100 transition-opacity ml-0.5">
                Beauty Care & Academy
              </span>
            </div>
          </Link>
...
//             <div className="flex flex-col" >
//               <span className="text-royal-yellow font-serif font-extrabold text-xl md:text-3xl leading-none tracking-tighter transition-colors group-hover:text-royal-gold">
//                 ROYAL TOUCH
//               </span>
...
//       {/* Mobile Sidebar */}
//       <div className={`fixed top-0 right-0 h-full w-[85%] max-w-sm bg-royal-purple/90 backdrop-blur-xl z-[102] shadow-[-10px_0_30px_rgba(0,0,0,0.5)] transform transition-transform duration-500 ease-out md:hidden border-l border-royal-gold/10 rounded-l-2xl ${
//         isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
//       }`}>
//         <div className="flex flex-col h-full overflow-y-auto pt-6 pb-10 px-8">
